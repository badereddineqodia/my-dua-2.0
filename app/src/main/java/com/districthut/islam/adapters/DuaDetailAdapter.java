 ...
 */
public class DuaDetailAdapter extends RecyclerView.Adapter<DuaDetailAdapter.DuaCategoryViewHolder> {
    ...
    public DuaDetailAdapter(Context mainActivity, String Category, String Language) {
        ...
        ArrayList<Dua> s = dbHeplper.GetDuasByTopic(Category,language);
        duas = s;
    ...
    public DuaDetailAdapter(Context mainActivity, ArrayList<Dua> duas) {
        context=mainActivity;
        dbHeplper = new DatabaseHelper(context);
        SP = PreferenceManager.getDefaultSharedPreferences(context);
        urdu = SP.getBoolean("urduCheck",true);
