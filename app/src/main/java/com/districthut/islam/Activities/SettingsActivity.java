...
public class SettingsActivity extends AppCompatActivity implements
    ...
    public static class HeaderFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            Preference preference = findPreference("prayer_timings");
            preference.setOnPreferenceClickListener(c-> {
                startActivity(new Intent(getActivity(), PrayerTimeActivity.class));
                return true;
            });
        }
    }
    ...
    public static class LanguageFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            Preference preference = findPreference("dark_mode");
    ...
    public static class PrayerTimesFragment extends PreferenceFragmentCompat {

        @Override
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            setPreferencesFromResource(R.xml.prayers_preferences, rootKey);
