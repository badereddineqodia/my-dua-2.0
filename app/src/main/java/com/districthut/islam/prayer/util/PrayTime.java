...
package com.districthut.islam.prayer.util;
...
public class PrayTime {
  ...
  public static LinkedHashMap<String, String> getPrayerTimesByDate(Context context, int index, double lat, double lng, int timeFormat, Calendar defaultCalc) {
