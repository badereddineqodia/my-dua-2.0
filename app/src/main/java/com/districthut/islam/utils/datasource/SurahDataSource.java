...
public class SurahDataSource {
    ...
    public ArrayList<Surah> getEnglishSurahArrayList() {
        ...
        cursor = db.rawQuery("SELECT * FROM surah_name", null);
        ...
        while (!cursor.isAfterLast()) {
            ...
            surah.setNo(cursor.getLong(cursor.getColumnIndex(SURAH_NO)));
            surah.setAyahNumber(cursor.getLong(cursor.getColumnIndex(SURAH_AYAH_NUMBER)));
            surah.setType(cursor.getString(cursor.getColumnIndex(SURAH_TYPE)));
            ...
            surah.setFont_type(cursor.getInt(cursor.getColumnIndex("font_type")));
            surah.setSurah_font(cursor.getString(cursor.getColumnIndex("surah_font")));
