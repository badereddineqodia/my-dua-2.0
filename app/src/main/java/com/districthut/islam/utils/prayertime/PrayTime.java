...
public class PrayTime {
  ...
  public static LinkedHashMap<String, String> getPrayerTimes(Context context, int index, double lat, double lng, int timeFormat) {
    ...
    double offsetFromUtc = defaultTz.getOffset(new Date().getTime()) / 3600000.0;
  ...
  public static LinkedHashMap<String, String> getPrayerTimesByDate(Context context, int index, double lat, double lng, int timeFormat,Date date) {
    AppSettings settings = AppSettings.getInstance(context);
    double latitude = lat;
    double longitude = lng;
    ...
    double offsetFromUtc = defaultTz.getOffset(date.getTime()) / 3600000.0;
